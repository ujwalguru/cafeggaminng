...
export function LiveRefreshPrompt({ visible }: { visible: boolean }) {
  ...
  return (
    <div className="fixed inset-x-0 top-2 z-[80] mx-auto flex w-[min(92vw,560px)] items-center justify-between gap-3 rounded-xl border border-primary/40 bg-card/95 px-4 py-3 text-sm text-foreground shadow-2xl backdrop-blur">
      <span className="text-center">Refresh to check the latest seat availability.</span>
